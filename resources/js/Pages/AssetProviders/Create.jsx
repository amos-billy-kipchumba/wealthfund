...
const Create = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    post(route('assetProviders.store'));
  };
  ...
  return (
    <Layout>
      ...
      <div className="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-md">
        <h1 className="text-3xl font-semibold mb-6">Create Asset Provider</h1>
        ...
        <div className="mt-6 text-center">
          <Link href={route('assetProviders.index')} className="text-indigo-600 hover:text-indigo-800">
